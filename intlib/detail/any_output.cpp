...
std::formatter<intlib::detail::AnyView>::OutT
std::formatter<intlib::detail::AnyView>::format(
	const intlib::detail::AnyView& view, std::format_context& ctx
) const
{
